...
class ObjectifSn(models.Model):
    ...
    def __str__(self):
        return f"ObjectifSn #{self.pk}"


class ObjectifSnChild0c8ff1d1(models.Model):
    parent = models.ForeignKey('ObjectifSn', on_delete=models.CASCADE, related_name='grp5_items')
    ...
    def __str__(self):
        return f"ObjectifSnChild0c8ff1d1 of {self.parent_id}[{self.item_index}]"
